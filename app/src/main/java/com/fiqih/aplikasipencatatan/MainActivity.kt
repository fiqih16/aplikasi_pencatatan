...
//    }
    ...
    fun updateRecordDialog(myActivityModel: MyActivityModel) {
        ...
        updateDialog.etUpdatepesan.setText(myActivityModel.description)
        ...
        updateDialog.tvUpdated.setOnClickListener(View.OnClickListener {
            val date = updateDialog.etUpdateDate.text.toString()
            val time = updateDialog.etUpdateTime.text.toString()
            val dateTime = "${date}(${time})"
            val description = updateDialog.etUpdatepesan.text.toString()
